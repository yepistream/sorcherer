(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Sorcherer = {}, global.THREE));
...
`;
  ...
  class Sorcherer {
    ...
    // For frustum culling.
    static frustum = new three.Frustum();
    ...
    static _tempWorldPos = new three.Vector3();
    static _tempProjectedPos = new three.Vector3();
    static _tempFrustumPos = new three.Vector3();
    ...
    static _parseVector3Attribute(element, name) {
      if (!element.hasAttribute(name)) return new three.Vector3();
     ...
     */
    constructor(object, offset = new three.Vector3(), simulate3D = false, simulateRotation = false, autoCenter = false, scaleMultiplier) {
      this.object = object;
